...
export default g.plugins.add('gjs-plugin-snippets', (editor, opts) => {
  let c = opts || {};
  ...
  let defaults = {
    blocks: ['form', 'input', 'textarea', 'select',
      'button', 'label', 'checkbox', 'snippets', 'compTable', 'compTableRow', 'compTableCell', 'Table', 'TableRow', 'TableCell'],
